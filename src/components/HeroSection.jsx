      ...
      <div className="flex flex-col lg:flex-row w-full flex-grow">
        <div className="w-full lg:w-1/2 bg-yellow-400 p-6 sm:p-10 flex flex-col justify-center items-center lg:items-start">
          ...
          <button 
            ...
            className="bg-green-500 text-white font-poppins px-6 py-3 font-bold rounded hover:bg-transparent border border-green-500 transition duration-300 w-max font-mono"
          >
            Lihat Menu
          </button>
        </div>
